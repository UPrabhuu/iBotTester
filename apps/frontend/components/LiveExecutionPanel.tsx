...
const LiveExecutionPanel: React.FC<LiveExecutionPanelProps> = ({
  ...
  return (
    <div className="w-96 bg-white border-l border-neutral-200 h-screen flex flex-col shadow-xl">
      {/* Header */}
      ...
      <div className="p-4 bg-neutral-50 border-b border-neutral-200">
        <div className="bg-white rounded-xl shadow-md overflow-hidden border border-neutral-300">
          {/* Browser Chrome */}
          <div className="bg-neutral-100 px-3 py-2 flex items-center space-x-2 border-b border-neutral-300">
            <div className="flex space-x-1.5">
              <div className="w-3 h-3 rounded-full bg-red-400"></div>
              <div className="w-3 h-3 rounded-full bg-yellow-400"></div>
              <div className="w-3 h-3 rounded-full bg-green-400"></div>
            </div>
            <div className="flex-1 bg-white rounded px-3 py-1 text-xs text-neutral-600 truncate border border-neutral-300">
              🔒 {currentUrl}
            </div>
          </div>
            ...
            {isExecuting ? (
              <div className="h-full flex items-center justify-center">
                <div className="text-center space-y-3">
                  ...
                  <p className="text-sm text-neutral-600">Executing test steps...</p>
                </div>
              </div>
            ) : (
              <div className="space-y-3">
                {/* Mock Amazon Product Card */}
                <div className="border border-neutral-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow">
                  ...
                  <div className="p-3">
                    ...
                    <p className="text-xs text-neutral-600 mb-2">Men&apos;s Size 9</p>
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-neutral-50">
        {activeTab === 'results' && (
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-neutral-700 mb-3">Execution Logs</h3>
            ...
            {logs.length > 0 ? (
              <div className="space-y-2">
                {logs.map((log, index) => (
                  <div
                    key={index}
                    className="bg-white border border-neutral-200 rounded-xl p-3 text-xs text-neutral-700 shadow-sm"
                  >
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-neutral-600">No execution logs yet</p>
        ...
        {activeTab === 'diff' && (
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-neutral-700 mb-3">Screenshot Comparison</h3>
            ...
            {screenshots.length >= 2 ? (
                ...
                <div className="grid grid-cols-2 gap-2">
                  {screenshots.slice(0, 2).map((screenshot) => (
                    <div key={screenshot.id} className="space-y-1">
                      <div className="bg-neutral-200 rounded-xl h-32 flex items-center justify-center border border-neutral-300">
                        <span className="text-2xl">📸</span>
                      </div>
                      <p className="text-xs text-neutral-600 text-center">{screenshot.label}</p>
                    </div>
                  ))}
                </div>
              ...
              <div className="text-center py-8">
                <div className="text-4xl mb-2">🔍</div>
                <p className="text-sm text-neutral-600">No screenshots to compare</p>
        ...
        {activeTab === 'video' && (
          <div className="text-center py-8">
            <div className="text-4xl mb-2">🎥</div>
            <p className="text-sm text-neutral-600">Video recording</p>
            <p className="text-xs text-neutral-500 mt-1">Available after test execution</p>
            <div className="mt-4 bg-neutral-200 rounded-xl h-48 flex items-center justify-center border border-neutral-300">
        ...
        {activeTab === 'logs' && (
          <div className="space-y-2">
            <h3 className="text-sm font-semibold text-neutral-700 mb-3">Technical Logs</h3>
            ...
            {logs.length > 0 ? (
              ...
              <div className="text-center py-8">
                <div className="text-4xl mb-2">📝</div>
                <p className="text-sm text-neutral-600">No logs available</p>
