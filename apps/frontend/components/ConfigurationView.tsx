    ...
    <div className="flex h-full">
      ...
      <div className="w-64 bg-white border-r border-neutral-200">
        <div className="p-4 border-b border-neutral-200">
          <h3 className="text-lg font-semibold text-neutral-800">Configuration</h3>
        </div>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            {activeSection === 'environment' && (
              <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 space-y-6">
                <h4 className="text-lg font-semibold text-neutral-800 mb-4">Environment Settings</h4>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-neutral-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-400"
                  />
                </div>

                <div className="border-t border-neutral-200 pt-4">
                  <h5 className="text-sm font-semibold text-neutral-700 mb-3">Credentials (Optional)</h5>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 space-y-6">
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-4 h-4 text-primary-600 border-neutral-300 rounded focus:ring-primary-400"
                  />
                  <label htmlFor="headless" className="text-sm font-medium text-neutral-700">
                    Run in headless mode
                  </label>
                </div>

                <div className="border-t border-neutral-200 pt-4">
                  <h5 className="text-sm font-semibold text-neutral-700 mb-3">Viewport (Optional)</h5>
            ...
            {activeSection === 'execution' && (
              <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6 space-y-6">
                <h4 className="text-lg font-semibold text-neutral-800 mb-4">Execution Preferences</h4>
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-4 h-4 text-primary-600 border-neutral-300 rounded focus:ring-primary-400"
                    />
                    <label htmlFor="screenshots" className="text-sm font-medium text-neutral-700">
                      Capture screenshots
                    </label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="w-4 h-4 text-primary-600 border-neutral-300 rounded focus:ring-primary-400"
                    />
                    <label htmlFor="video" className="text-sm font-medium text-neutral-700">
                      Record video
                    </label>
                  </div>
                </div>
            ...
            {activeSection === 'integrations' && (
              <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <h4 className="text-lg font-semibold text-neutral-800 mb-4">Integration Settings</h4>
                <div className="text-center py-8">
                  <div className="text-4xl mb-2">🔗</div>
                  <p className="text-sm text-neutral-600">No integrations configured</p>
                  <p className="text-xs text-neutral-500 mt-1">Add integrations to connect with external services</p>
                </div>
              </div>
            )}
            ...
            {activeSection === 'variables' && (
              <div className="bg-white rounded-xl shadow-sm border border-neutral-200 p-6">
                <h4 className="text-lg font-semibold text-neutral-800 mb-4">Variables & Constants</h4>
                <div className="text-center py-8">
                  <div className="text-4xl mb-2">📝</div>
                  <p className="text-sm text-neutral-600">No variables defined</p>
                  <p className="text-xs text-neutral-500 mt-1">Add variables to reuse across your tests</p>
                </div>
              </div>
            )}
            ...
            <div className="mt-6">
              <button
                onClick={handleSave}
                className="w-full px-5 py-2.5 bg-primary-500 text-white rounded-lg hover:bg-primary-600 transition-smooth font-medium"
              >
                Save Configuration
              </button>
            </div>
